...
model = build_app(
    {"model": os.environ['MODEL_ID'], "tensor-parallel-size": os.environ['TENSOR_PARALLELISM'],"max-model-len": os.environ['MAX_MODEL_LEN'], "pipeline-parallel-size": os.environ['PIPELINE_PARALLELISM'],"dtype": os.environ['DTYPE']})
